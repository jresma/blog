...
(function() {
  ...
  Blog.Views.Post_Add_Form = (function(_super) {
    ...
    Post_Add_Form.prototype.events = function() {
      return {
        'submit form': 'save'
      };
    };
...
(function() {
  ...
  Blog.Views.Post_Detail = (function(_super) {
    __extends(Post_Detail, _super);

    function Post_Detail() {
      return Post_Detail.__super__.constructor.apply(this, arguments);
    }

    Post_Detail.prototype.tagName = 'li';

    Post_Detail.prototype.template = 'post-detail';
...
(function() {
  ...
  Blog.Views.Post_list = (function(_super) {
    ...
    Post_list.prototype.addOne = function(model) {
      var item;
      item = new Blog.Views.Post_Detail({
        model: model
      });
    ...
    Post_list.prototype.new_post = function() {
      debugger;
      var form;
      form = new Blog.Views.Post_Add_Form();
      return $('div[data-target-template="Blog-Views-Post-Add-Form"]').html(form.render().el);
    };
